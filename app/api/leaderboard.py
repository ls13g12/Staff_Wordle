...
def leaderboard_api():
    ...
    if filter == 'today':
        ...
        word_users = UserWordLink.query.filter(UserWordLink.date >= starting_date, UserWordLink.date < tomorrows_date
    ...
    return make_response(jsonify({'initials' : initials_arr, 'guesses': average_guesses_arr}),200 )
