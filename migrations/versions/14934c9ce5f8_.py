...
Revision ID: 14934c9ce5f8
Revises: 765856fd2578
Create Date: 2022-02-08 18:02:42.194326
...
revision = '14934c9ce5f8'
down_revision = '765856fd2578'
branch_labels = None
depends_on = None
...
def upgrade():
    ...
    op.add_column('user', sa.Column('initials', sa.String(length=3), nullable=True))
